from chatterbotpro.adapters import Adapter
from chatterbotpro.storage import StorageAdapter
from chatterbotpro.search import IndexedTextSearch
...
class LogicAdapter(Adapter):
    ...
    def __init__(self, chatbot, **kwargs):
        ...
        from chatterbotpro.response_selection import get_first_response
